...
final List<Product> sampleProducts = [
  ...
  Product(
    ...
    image: "assets/imagem_serum_1.png",
    price: 129.9,
    category: "Pele",
  ),
  Product(
    name: "Protetor Solar FPS 70",
    image: "assets/imagem_protetor_1.png",
    price: 89.9,
    category: "Pele",
  ),
  Product(
    name: "Gel de Limpeza Facial",
    image: "assets/imagem_hidratante_1.png",
    price: 39.9,
    category: "Pele",
  ),
  Product(
  ...
  Product(
    ...
    image: "assets/imagem_creme_1.png",
    price: 29.9,
    category: "Pele",
  ),
  Product(
    name: "Esfoliante Facial Suave",
    image: "assets/imagem_esfoliante_1.png",
    price: 34.9,
    category: "Pele",
  ),
  Product(
    name: "Água Micelar",
    image: "assets/imagem_agua_1.png",
    price: 44.9,
    category: "Pele",
  ),
  Product(
  ...
  Product(
    ...
    image: "assets/imagem_esfoliante_2.png",
    price: 64.9,
    category: "Pele",
  ),
  ...
  Product(
    ...
    image: "assets/imagem_base_1.png",
    price: 89.9,
    category: "Rosto",
  ),
  Product(
    name: "Corretivo Alta Cobertura",
    image: "assets/imagem_corretivo_1.png",
    price: 59.9,
    category: "Rosto",
  ),
  Product(
    name: "Pó Compacto Translúcido",
    image: "assets/imagem_po_compacto_1.png",
    price: 49.9,
    category: "Rosto",
  ),
  Product(
  ...
  Product(
    name: "Bruma Glow",
    image: "assets/imagem_bruma_1.png",
    price: 39.9,
    category: "Rosto",
  ),Product(
    name: "Bruma com Glitter",
    image: "assets/imagem_bruma_2.png",
    price: 39.9,
    category: "Rosto",
  ),
  Product(
    name: "Pó Solto Translúcido",
    image: "assets/imagem_po_solto_1.png",
    price: 49.9,
    category: "Rosto",
  ),
  Product(
    name: "Blush Líquido",
    image: "assets/imagem_blush_pó_2.png",
    price: 39.9,
    category: "Rosto",
  ),
  Product(
    name: "Iluminador Líquido",
    image: "assets/imagem_iluminador_2.png",
    price: 54.9,
    category: "Rosto",
  ),
  Product(
    name: "Iluminador Líquido Glow",
    image: "assets/imagem_iluminador_3.png",
    price: 54.9,
    category: "Rosto",
  ),
  Product(
    name: "Batom Vermelho Luxo",
    image: "assets/imagem_batao_1.png",
    price: 49.9,
    category: "Rosto",
  ),
  Product(
    ...
    image: "assets/imagem_gloss_6.png",
    price: 29.9,
    category: "Rosto",
  ),
  Product(
    name: "Blush Bastão",
    image: "assets/imagem_blush_bastão.png",
    price: 39.9,
    category: "Rosto",
  ),
  Product(
    name: "Paleta de Sombras Neutras",
    image: "assets/imagem_sombra_1.png",
    price: 99.9,
    category: "Rosto",
  ),
  Product(
  ...
  Product(
    ...
    image: "assets/imagem_deliniador_1.png",
    price: 34.9,
    category: "Rosto",
  ),
  Product(
    name: "Máscara de Cílios Volume",
    image: "assets/imagem_rimel_1.png",
    price: 69.9,
    category: "Rosto",
  ),
   Product(
    name: "Base Líquida Matte",
    image: "assets/imagem_base_liquida_2.png",
    price: 89.9,
    category: "Rosto",
  ),
   Product(
    name: "Base Líquida Matte",
    image: "assets/imagem_base_liquida.png",
    price: 89.9,
    category: "Rosto",
  ),
